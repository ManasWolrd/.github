...
[SteepFlanger](https://github.com/ManasWolrd/SteepFlanger): Barberpole FIR/IIR(WIP) flanger plugin. Use really steep notches to create highly flanged sound or push it to max for robotic resonating voice.  
~[GreenVocoder](https://github.com/ManasWolrd/GreenVocoder): Multiple algorithms vocoder plugin.~  

## old plugins
checkout https://github.com/ManasWolrd/dev-plugins
